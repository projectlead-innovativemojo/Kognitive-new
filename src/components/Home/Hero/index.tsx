        ...
        <div className="w-full h-full max-w-[1200px] md:mt-[128px] mt-[60px]">
          <BackgroundBeamsWithCollision>
            <Text as="h1" className="mb-[50px] text-[#F5F5FA] text-center">
              Hire 6 AI Voice Employees for Less Than $1/Hour
            </Text>
            <Text
              as="h2"
              className="text-[#F5F5FA] text-center mb-10 md:mb-[140px] font-normal md:leading-[45px]">
              <span className=" font-bold"> Kognitiiv.ai</span> gives your
              business a full team of AI voice agents that handle sales,
              support, marketing, and more <br className="md:block hidden" />{" "}
              24/7, no breaks, no burnout
            </Text>
            <Text className="md:text-[24px] text-[20px] font-medium text-[#F5F5FA] text-center">
              Be among the first to access this game-changing workforce.{" "}
              <br className="md:block hidden" />
              Join the waitlist to claim early access + exclusive launch perks
            </Text>
          </BackgroundBeamsWithCollision>
        </div>
        <div className="">
