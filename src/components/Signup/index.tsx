    ...
    <div className="w-full h-full bg-white flex justify-center items-center px-4 mt-[80px]">
      <div className="w-full h-full bg-white max-w-[1260px] flex md:flex-row flex-col justify-between items-start">
        <div>
          ...
          />
          <Text className="text-transparent text-center bg-clip-text bg-gradient-to-r from-[#5F27CD] to-[#40E0D0] text-[40px] font-semibold">
            Kognitiiv.ai
          </Text>
        </div>
        <div className="w-full md:max-w-[514px] max-w-full">
          <form className="w-full max-w-full md:max-w-[514px] p-10 shadow-[0px_7px_29px_0px_#64646F33] bg-white rounded-[12px] mt-[60px] mb-[268px]">
            <div className="flex flex-col gap-[24px] md:flex-row mb-[30px]">
              <div className="p-[2px] rounded-[12px] bg-gradient-to-b from-[#5F27CD] to-[#00CEC9]">
                <input
                  type="text"
                  placeholder="Name"
            ...
            <div className="p-[2px] rounded-[12px] bg-gradient-to-b from-[#5F27CD] to-[#00CEC9] mb-[30px]">
              <input
                type="email"
                placeholder="Email"
            ...
            <div className="p-[2px] rounded-[12px] bg-gradient-to-b from-[#5F27CD] to-[#00CEC9] mb-[70px]">
              <select
            ...
            <div className="rounded-[12px]">
              <button
                className="w-full h-[50px] rounded-[10px] bg-[#0F0F1A] text-white text-[18px] 
        shadow-[0px_-10px_10px_-5px_#00B5AD0A,0px_10px_15px_-5px_#5F27CD80]"
              >
                Join the Waitlist
              </button>
            </div>
